INSERT INTO test.accounts(email, password, salt, reminder)
VALUES
...
INSERT INTO test.refresh_tokens(token, account_id)
VALUES
(
  'refresh_token_1',
  (SELECT id FROM test.accounts WHERE email = 'dominik.krenski@gmail.com')
),
(
  'refresh_token_2',
  (SELECT id FROM test.accounts WHERE email = 'dominik.krenski@gmail.com')
